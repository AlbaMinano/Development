...
%%% Alba Miñano Mañero
%%% 29th January 2019
%% Question 2, part 1:Negative correlation between LS and consumption seasonality
%% NOTE: NON SEASONAL COMPONENTS ARE NEGATIVELY CORRELATED HERE
close all
clear all
rng(1234)
...
% 3.2) Obtain labour, same procedure 
for a = 1:A
    for i = 1:N
        lsNonSeasonal(i, :, a) = -nonSeasonal(i, :, a);
    end
end

for month = 1:T 
    eLmHigh(month,1) = eGmHigh(month,1);
    eLmMiddle(month,1) = eGmMiddle(month,1);
    eLmLow(month,1) = eGmLow(month,1);
end
